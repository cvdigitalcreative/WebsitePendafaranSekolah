                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $fase_3[$i]['nilai_rata_rata']; ?></td>
                          <?php if($fase_3[$i]['status_raport']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_raport?email='.$fase_3[$i]['email'].'&nilai_rata_rata='.$fase_3[$i]['nilai_rata_rata'])?>">Konfirmasi</a></td>
                               <td>
                                <form  action="<?php echo base_url(); ?>Admin/update_raport_with_post" method="post">
                                <input type="text" style="display: none;" id="email" name="email" value="<?php echo $fase_3[$i]['email']; ?>" >
                                 <input type="text" id="nilai_rata_rata" name="nilai_rata_rata" >
