                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $fase_3[$i]['jumlah_organisasi']; ?></td>
                          <?php if($fase_3[$i]['status_organisasi']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_organisasi?email='.$fase_3[$i]['email'].'&jumlah_organisasi='.$fase_3[$i]['jumlah_organisasi'])?>">Konfirmasi</a></td>
                               <td>
                                <form  action="<?php echo base_url(); ?>Admin/update_organisasi_with_post" method="post">
                                <input type="text" style="display: none;" id="email" name="email" value="<?php echo $fase_3[$i]['email']; ?>" >
                                 <input type="text" id="jumlah_organisasi" name="jumlah_organisasi" >
