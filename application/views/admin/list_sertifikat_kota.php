                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $fase_3[$i]['jumlah_sertifikat_kota']; ?></td>
                          <?php if($fase_3[$i]['status_sertifikat_kota']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_sertifikat_kota?email='.$fase_3[$i]['email'].'&jumlah_sertifikat_kota='.$fase_3[$i]['jumlah_sertifikat_kota'])?>">Konfirmasi</a></td>
                               <td>
                                <form  action="<?php echo base_url(); ?>Admin/update_sertifikat_kota_with_post" method="post">
                                <input type="text" style="display: none;" id="email" name="email" value="<?php echo $fase_3[$i]['email']; ?>" >
                                 <input type="text" id="jumlah_sertifikat_kota" name="jumlah_sertifikat_kota" >
