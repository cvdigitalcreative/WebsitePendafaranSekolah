                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>ID</th>
                          <th>Nama</th>
                          <th>Skor Dimensi 1</th>
                           <th>Skor Dimensi 2</th>
                            <th>Total Skor</th>
                             <th>Notes</th>
                              <th>Action</th>
                      ...
                      <tbody>
                         ...
                         <?php 
                        $nomor=1;
                        for ($i=0; $i<sizeof($siswa_all); $i++){
                        ?>
                        <tr>
                           <td><?php echo $nomor; ?></td>
                          <td><?php echo $siswa_all[$i]['id']; ?></td>
                          <td><?php echo $siswa_all[$i]['nama']; ?></td>
                           <td><?php echo $siswa_all[$i]['skor_dimensi_1']; ?></td>
                            <td><?php echo $siswa_all[$i]['skor_dimensi_2']; ?></td>
                             <td><?php echo $siswa_all[$i]['skor_total']; ?></td>
                              <td><?php echo $siswa_all[$i]['notes']; ?></td>
                          <?php if($siswa_all[$i]['status_fase']==0) : ?>
                            <td>
                                <form  action="<?php echo base_url(); ?>Admin/update_status_fase" method="post">
                                <input type="text" style="display: none;" id="email" name="email" value="<?php echo $siswa_all[$i]['email']; ?>" >
                                 <input type="text" id="status_fase" name="status_fase" value="1" style="display: none;">
                                
                                <input type="submit" value="Layak">
                                </form>
                                <form  action="<?php echo base_url(); ?>Admin/update_status_fase" method="post">
                                <input type="text" style="display: none;" id="email" name="email" value="<?php echo $siswa_all[$i]['email']; ?>" >
                                 <input type="text" id="status_fase" name="status_fase" value="2" style="display: none;">
                                
                                <input type="submit" value="Tidak Layak">
                                </form>
                               </td>
                          <?php else : ?>
                               
                              
                              <td>Sudah Dimasukan</td>
