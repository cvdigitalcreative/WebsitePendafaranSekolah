                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $fase_3[$i]['jumlah_juara_seni']; ?></td>
                          <?php if($fase_3[$i]['status_kreatifitas']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_seni?email='.$fase_3[$i]['email'].'&jumlah_juara_seni='.$fase_3[$i]['jumlah_juara_seni'])?>">Konfirmasi</a></td>
                               <td>
                                <form  action="<?php echo base_url(); ?>Admin/update_seni_with_post" method="post">
                                <input type="text" style="display: none;" id="email" name="email" value="<?php echo $fase_3[$i]['email']; ?>" >
                                 <input type="text" id="jumlah_juara_seni" name="jumlah_juara_seni" >
