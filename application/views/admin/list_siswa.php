                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>Fotokopi Rapor</th>
                          <th>Pas Foto berwarna</th>
                          <th>Fotokopi KTP</th>
                          <th>Fotokopi Kartu Keluarga</th>
                          <th>Formulir Referensi</th>
                          <th>Fotokopi Rekening Listrik</th>
                           <th>Fotokopi Slip Gaji</th>
                          <th>Surat Keterangan Tidak Mampu</th>
                          <th>Fotokopi Ijazah dsb</th>
                        </tr>
                      </thead>
                      ...
                      <tbody>
                         ...
                         <?php 
                        $nomor=1;
                        for ($i=0; $i<sizeof($fase_1); $i++){
                        ?>
                        <tr>
                           <td><?php echo $nomor; ?></td>
                          <td><?php echo $fase_1[$i]['id']; ?></td>
                          <td><?php echo $fase_1[$i]['nama']; ?></td>
                          <td><?php echo $fase_1[$i]['nomor_telpon']; ?></td>
                          <?php if($fase_1[$i]['melengkapi_data']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_melengkapi_data?email='.$fase_1[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>

                          <?php if($fase_1[$i]['fotokopi_rapor']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_fotokopi_rapor?email='.$fase_1[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>
                           
                          <?php if($fase_1[$i]['pas_foto']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_pas_foto?email='.$fase_1[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>
                           
                           <?php if($fase_1[$i]['fotokopi_ktp']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_fotokopi_ktp?email='.$fase_1[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>

                           <?php if($fase_1[$i]['fotokopi_kk']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_fotokopi_kk?email='.$fase_1[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>
                           
                            <?php if($fase_1[$i]['formulir_referensi']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_formulir_referensi?email='.$fase_1[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>
                           
                            
                          <?php if($fase_1[$i]['fotokopi_rekening_listrik']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_fotokopi_rekening_listrik?email='.$fase_1[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>

                          <?php if($fase_1[$i]['fotokopi_slip_gaji']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_fotokopi_slip_gaji?email='.$fase_1[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>

                          <?php if($fase_1[$i]['surat_keterangan_tidak_mampu']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_surat_keterangan_tidak_mampu?email='.$fase_1[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>

                          <?php if($fase_1[$i]['fotokopi_ijazah']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_fotokopi_ijazah?email='.$fase_1[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>
