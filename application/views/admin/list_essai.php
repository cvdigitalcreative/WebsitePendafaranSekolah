                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $fase_3[$i]['essai']; ?></td>
                          <?php if($fase_3[$i]['status_essai']==0) : ?>
                             
                               <td>
                                <form  action="<?php echo base_url(); ?>Admin/update_skor_essai" method="post">
                                <input type="text" style="display: none;" id="email" name="email" value="<?php echo $fase_3[$i]['email']; ?>" >
                                 <input type="text" id="skor_essai" name="skor_essai" >
