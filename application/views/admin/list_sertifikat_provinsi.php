                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>Nama</th>
                          <th>Nomor HP</th>
                          <th>Sertifikat Tingkat Provinsi</th>
                          <th>Action</th>
                          <th>Masukan</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $fase_3[$i]['jumlah_sertifikat_provinsi']; ?></td>
                          <?php if($fase_3[$i]['status_sertifikat_provinsi']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_sertifikat_provinsi?email='.$fase_3[$i]['email'].'&jumlah_sertifikat_provinsi='.$fase_3[$i]['jumlah_sertifikat_provinsi'])?>">Konfirmasi</a></td>
                               <td>
                                <form  action="<?php echo base_url(); ?>Admin/update_sertifikat_provinsi_with_post" method="post">
                                <input type="text" style="display: none;" id="email" name="email" value="<?php echo $fase_3[$i]['email']; ?>" >
                                 <input type="text" id="jumlah_sertifikat_provinsi" name="jumlah_sertifikat_provinsi" >
