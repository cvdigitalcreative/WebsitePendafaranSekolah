                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>Nomor HP</th>
                          <th>WNI Domisili</th>
                          <th>Usia 14-16 Tahun</th>
                          <th>Rata-Rata Raport</th>
                          <th>Peringkat 10</th>
                          <th>Tagihan Listrik</th>
                          <th>Dukungan Referensi</th>
                           <th>Lulusan Maksimal</th>
                          <th>Tidak Sedang Menjabat</th>
                      ...
                      <tbody>
                         ...
                         <?php 
                        $nomor=1;
                        for ($i=0; $i<sizeof($fase_2); $i++){
                        ?>
                        <tr>
                           <td><?php echo $nomor; ?></td>
                          <td><?php echo $fase_2[$i]['id']; ?></td>
                          <td><?php echo $fase_2[$i]['nama']; ?></td>
                          <td><?php echo $fase_2[$i]['nomor_telpon']; ?></td>
                          
                          <?php if($fase_2[$i]['wni_domisili']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_wni_domisili?email='.$fase_2[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>

                          <?php if($fase_2[$i]['usia_diatas_14']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_usia_diatas_14?email='.$fase_2[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>
                           
                          <?php if($fase_2[$i]['rata_rata_rapor']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_rata_rata_rapor?email='.$fase_2[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>

                          <?php if($fase_2[$i]['peringkat_10']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_peringkat_10?email='.$fase_2[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>
                           
                           <?php if($fase_2[$i]['tagihan_listrik']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_tagihan_listrik?email='.$fase_2[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>

                           <?php if($fase_2[$i]['dukungan_referensi']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_dukungan_referensi?email='.$fase_2[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>
                           
                            <?php if($fase_2[$i]['lulusan_maksimal']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_lulusan_maksimal?email='.$fase_2[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>
                           
                            
                          <?php if($fase_2[$i]['tidak_sedang_menjabat']==0) : ?>
                               <td><a href="<?php echo site_url('Admin/update_tidak_sedang_menjabat?email='.$fase_2[$i]['email'])?>">Konfirmasi</a></td>
                          <?php else : ?>
                               <td>Sudah Dikonfirmasi</td>
                          <?php endif; ?>
