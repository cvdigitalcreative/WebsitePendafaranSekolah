                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <?php if($fase_3[$i]['status_juara_umum']==0) : ?>
                             
                               <td>
                                <form  action="<?php echo base_url(); ?>Admin/update_skor_juara_umum" method="post">
                                <input type="text" style="display: none;" id="email" name="email" value="<?php echo $fase_3[$i]['email']; ?>" >
                                 <input type="text" id="skor_juara_umum" name="skor_juara_umum" >
