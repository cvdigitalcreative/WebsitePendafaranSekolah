                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <?php if($fase_3[$i]['status_notes']==0) : ?>
                             
                               <td>
                                <form  action="<?php echo base_url(); ?>Admin/update_notes" method="post">
                                <input type="text" style="display: none;" id="email" name="email" value="<?php echo $fase_3[$i]['email']; ?>" >
                                <textarea rows="10" cols="10" name="notes" id="notes" style="margin-left: 0px; margin-right: 0px; width: 444px;"></textarea>
