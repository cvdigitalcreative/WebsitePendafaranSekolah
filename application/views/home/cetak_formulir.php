          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Cetak Formulir Pendaftaraan</h2>
                    
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      
                      <a href="<?php echo base_url(); ?>/Create_pdf/print_item" target="_blank">Cetak Formulir Pendaftaraan</a>
                  </div>

                  <div class="x_title">
                    <h2>Cetak Dokumen Rekomendasi Sekolah dan Denah Rumah</h2>
                    
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      
                      <a href="<?php echo base_url(); ?>/Create_pdf/download" target="_blank">Cetak Dokumen Rekomendasi Sekolah dan Denah Rumah</a>
                  </div>
